...
parent_save_dir = '/media/dmlab/My Passport/DATA/cross-domain/finetune_upper_limit_using_post-trained'
...
if __name__=='__main__':
    ...
    for train_filepath in train_filepaths:
        for mode in ['unk', 'raw']:
            ...
            model_name_or_dir = post_trained_dir_format.format(domain, mode)
