...
post_filepaths = glob('/media/dmlab/My Passport/DATA/cross-domain/data/MDSD_*_*_for_post.txt')
post_parent_save_dir = '/media/dmlab/My Passport/DATA/cross-domain/post-train'
