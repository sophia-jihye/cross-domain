...
post_trained_dirs = [d for d in glob('/media/dmlab/My Passport/DATA/cross-domain/post-train/*&*_unk-specific') if os.path.isdir(d)]
...
parent_save_dir = '/media/dmlab/My Passport/DATA/cross-domain/finetune_using_post-trained_unk-specific'
